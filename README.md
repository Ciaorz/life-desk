...
| 类目 | 数据文件 | 封面目录 | 条目数 |
| --- | --- | --- | --- |
| ip | `ip-data.json` | `images/ip-封面/` | 0 |
| series | `series-data.json` | `images/系列-封面/` | 0 |
| 电影 | `电影-data.json` | `images/电影-封面/` | 0 |
| 留声机 | `留声机-data.json` | `images/留声机-封面/` | 0 |
| 书籍 | `书籍-data.json` | `images/书籍-封面/` | 0 |
| 杂志 | `杂志-data.json` | `images/杂志-封面/` | 0 |
