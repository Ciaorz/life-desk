...
| 类目 | 数据文件 | 封面目录 | 条目数 |
| --- | --- | --- | --- |
| ip | `ip-data.json` | `images/ip-封面/` | 1 |
| series | `series-data.json` | `images/系列-封面/` | 1 |
| 去过的地方 | `去过的地方-data.json` | `images/去过的地方-封面/` | 2 |
| 想去的地方 | `想去的地方-data.json` | `images/想去的地方-封面/` | 1 |
| 电影 | `电影-data.json` | `images/电影-封面/` | 2 |
| 留声机 | `留声机-data.json` | `images/留声机-封面/` | 1 |
| 书籍 | `书籍-data.json` | `images/书籍-封面/` | 1 |
| 杂志 | `杂志-data.json` | `images/杂志-封面/` | 1 |
| 餐厅 | `餐厅-data.json` | `images/餐厅-封面/` | 1 |
| 美食 | `美食-data.json` | `images/美食-封面/` | 1 |
| 菜谱 | `菜谱-data.json` | `images/菜谱-封面/` | 1 |
| 徽章 | `徽章-data.json` | `images/徽章-封面/` | 2 |
